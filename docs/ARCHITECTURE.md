...
telemetry), `docs/BUFFER.md` (buffer state, the text scale), `docs/FACES.md` (faces, defaults, themes), `docs/HOOKS.md` (the hooks and their API), `docs/KEYMAPS.md` (named keymaps and the ladder), `docs/MODES.md` (major, derived, and minor modes),
