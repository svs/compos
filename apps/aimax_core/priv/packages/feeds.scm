...
;;; live in ~/.aimax/feeds, one URL per line; the read links live in
;;; ~/.aimax/feeds-read.
...
(define *feeds-file* (string-append (aimax-home) "/feeds"))
(define *feeds-read-file* (string-append (aimax-home) "/feeds-read"))
