defmodule Compos.UregisterSchemeTest do
  @moduledoc """
  Runs priv/tests/register-test.scm alone: register.
  """
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "register-test.scm"])
  ...
  @tag timeout: 120_000
  test "register-test.scm passes" do
    eval!(~s{(load "#{@file_}")})
    names = names()
