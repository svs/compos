defmodule Aimax.Core.BufferView do
  @moduledoc """
  ...
  this, `Aimax.Core.Editor` called each visible buffer from inside its own
  ...
  alias Aimax.Core.Buffer.Ref
  alias Aimax.Core.Rope

  @table :aimax_buffer_view
