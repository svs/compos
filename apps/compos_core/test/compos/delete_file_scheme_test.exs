defmodule Compos.DeleteFileSchemeTest do
  @moduledoc """
  Runs priv/tests/delete-file-test.scm alone: delete-file offers this buffer's file and trashes first.
  """
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "delete-file-test.scm"])
  ...
  @tag timeout: 120_000
  test "delete-file-test.scm passes" do
    eval!(~s{(load "#{@file_}")})
    names = names()
