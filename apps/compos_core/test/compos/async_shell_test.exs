defmodule Compos.AsyncShellTest do
  @moduledoc """
  ...
  test "the inline form kills the command at the limit and returns its output" do
    Application.put_env(:compos_core, :shell_timeout_ms, 500)
    on_exit(fn -> Application.delete_env(:compos_core, :shell_timeout_ms) end)
