...
;;; COMPOS_AGENT env, and the branch all carry the same identity.
...
(define (worktree--runs-compos? root)
  (and (file-exists? (string-append root "/mix.exs"))
       (file-directory? (string-append root "/apps/compos_core"))))
