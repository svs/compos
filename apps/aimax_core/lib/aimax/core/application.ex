defmodule Aimax.Core.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Registry, keys: :unique, name: Aimax.Core.TerminalRegistry},
      ...
      {Registry, keys: :unique, name: Aimax.Core.EndpointRegistry},
      {Registry, keys: :unique, name: Aimax.Core.DBRegistry},
      {Registry, keys: :unique, name: Aimax.Core.WebServerRegistry},
      ...
      {DynamicSupervisor, name: Aimax.Core.TerminalSupervisor, strategy: :one_for_one},
      ...
      {DynamicSupervisor, name: Aimax.Core.EndpointSupervisor, strategy: :one_for_one},
      {DynamicSupervisor, name: Aimax.Core.DBSupervisor, strategy: :one_for_one},
      {DynamicSupervisor, name: Aimax.Core.WebServerSupervisor, strategy: :one_for_one},
