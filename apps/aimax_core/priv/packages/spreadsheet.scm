...
(define spreadsheet--app-html
  (string-append
    ...
    "var endpoint='_aimax/spreadsheet',api=null,book=null,model=null,timer=null,saving=false,again=false,loading=true,chartRefreshTimer=null,chartDisposables=[],chartMounted=[],chartDrawn=[],chartFailed=[],chartReport=Promise.resolve();"
