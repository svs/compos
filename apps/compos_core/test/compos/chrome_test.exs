defmodule Compos.ChromeTest do
  @moduledoc """
  The browser wire, both directions.

  No Chrome here — `Compos.Core.Browser` runs against a stub socket process, the
  ...
  describe "inbound — a tab asks the daemon" do
    ...
    # the same query ranked differently in a tab than in compos.
