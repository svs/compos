defmodule Compos.BackendStubTest.NoTransport do
...
defmodule Compos.BackendStubTest do
  @moduledoc """
  ...
  setup do
    ...
    Application.put_env(:compos_core, :acp_transport, Compos.BackendStubTest.NoTransport)
