...
(define (spreadsheet--app-html)
  (let ((dark? (and (boundp 'theme-dark?) (theme-dark?))))
    ...
    "var endpoint='_compos/spreadsheet',api=null,book=null,model=null,timer=null,saving=false,again=false,loading=true,chartRefreshTimer=null,chartDisposables=[],chartMounted=[],chartDrawn=[],chartFailed=[],chartReport=Promise.resolve();"
