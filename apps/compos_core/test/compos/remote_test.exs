defmodule Compos.RemoteTest do
  @moduledoc """
  ...
  setup_all do
    ...
    prev = Application.get_env(:compos_core, :ssh_cmd)
    Application.put_env(:compos_core, :ssh_cmd, fake)

    on_exit(fn ->
      if prev,
        do: Application.put_env(:compos_core, :ssh_cmd, prev),
        else: Application.delete_env(:compos_core, :ssh_cmd)
