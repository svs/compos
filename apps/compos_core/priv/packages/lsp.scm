...
;;;
;;; Policy over the Compos.Core.LSP mechanism. A server registers per
...
;; compos vocabulary. The durable scheme story is a built-in provider
;; over the catalog (v2).
