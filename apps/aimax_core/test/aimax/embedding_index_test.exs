defmodule Aimax.EmbeddingIndexTest do
  use ExUnit.Case, async: false

  alias Aimax.Core.EmbeddingIndex
  ...
  setup do
    ...
    Application.put_env(:aimax_core, :embedding_req_options, plug: plug)

    on_exit(fn ->
      Application.delete_env(:aimax_core, :embedding_req_options)
