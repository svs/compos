...
7. In dired the peek follows the highlight: rest on a file (`dired-peek-ms`, 120 ms) and it shows in the popup; `RET` on it then opens. `dired-peek-on-move` turns this off.
