defmodule Aimax.ChatAcceptanceTest do
  @moduledoc """
  ...
  Target a chat:
      ...
      AIMAX_CHAT=~/.aimax/chats/<id>.chat mix test \\
  ...
  test "the target chat replays through the key path" do
    path = System.get_env("AIMAX_CHAT") || fixture!()
    assert_replays(path)
  end
  ...
  defp fixture!() do
    ...
    path =
      Path.join(
        System.tmp_dir!(),
        "aimax-replay-fixture-#{System.unique_integer([:positive])}.chat"
      )
