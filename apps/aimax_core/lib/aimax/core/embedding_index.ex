defmodule Aimax.Core.EmbeddingIndex do
  @moduledoc """
  ...
  def cache_path, do: Path.join([Aimax.Core.home(), "cache", "apropos-embeddings.etf"])
  ...
  defp request(inputs, api_key, model, dimensions, opts) do
    req_opts =
      ...
      ] ++ Application.get_env(:aimax_core, :embedding_req_options, [])
