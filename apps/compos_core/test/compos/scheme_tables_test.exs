defmodule Compos.SchemeTablesTest do
  @moduledoc """
  ...
  alias Compos.Core.{SchemeAPI, SchemeTables, Session}
  ...
  defp restart_session! do
    :ok = Supervisor.terminate_child(Compos.Core.Supervisor, Session)
    {:ok, pid} = Supervisor.restart_child(Compos.Core.Supervisor, Session)
