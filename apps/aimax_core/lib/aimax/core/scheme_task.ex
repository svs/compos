defmodule Aimax.Core.SchemeTask do
  @moduledoc """
  ...
  alias Aimax.Core.{Frame, SchemeReadLimiter, Session}
  alias Aimax.Scheme

  @registry Aimax.Core.SchemeTaskRegistry
  @supervisor Aimax.Core.SchemeTaskSupervisor
