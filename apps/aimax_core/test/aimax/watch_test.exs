defmodule Aimax.WatchTest.NoBackend do
  @moduledoc """
...
defmodule Aimax.WatchTest do
  ...
  alias Aimax.Core.{Events, Session, Watch}

  # 150 ms debounce; give a real fsevent room before we decide nothing came
  @settle 700

  setup do
    dir = Path.join(System.tmp_dir!(), "aimax-watch-#{System.unique_integer([:positive])}")
