...
;;; The store is Scheme data under <aimax-home>. The list supports marks, filters,
...
(defcustom 'bookmark-default-file (string-append (aimax-home) "/bookmarks.scd")
...
(define (bookmark--write-file! path)
  (let ((full (expand-path path)))
    ...
    (write-file! full
      (string-append
        ";;; bookmarks.scd --- ai-max Scheme data, format 1.\n"
