...
(define-theme "paper"                ; the design default (light) — restorable
  (list
    ...
    (list 'org-level-1 'fg "#26356b" 'weight "700" 'size "1.6em")
    (list 'org-level-2 'fg "#7a5a1a" 'weight "600" 'size "1.3em")
    (list 'org-level-3 'fg "#3d6b4f" 'weight "600" 'size "1.12em")
    (list 'org-level-4 'fg "#6b3d5b" 'weight "600" 'size "1em")
...
(define-theme "paper-night"          ; the design's warm dark
  (list
    ...
    (list 'org-level-1 'fg "#9fb0ea" 'weight "700" 'size "1.6em")
    (list 'org-level-2 'fg "#d5ac66" 'weight "600" 'size "1.3em")
    (list 'org-level-3 'fg "#79bd93" 'weight "600" 'size "1.12em")
    (list 'org-level-4 'fg "#c99ac2" 'weight "600" 'size "1em")
