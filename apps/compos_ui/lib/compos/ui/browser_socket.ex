defmodule Compos.Ui.BrowserSocket do
  @moduledoc """
  Raw WebSocket the compos Chrome extension dials to reach this daemon.

  No channels and no LiveView — the frames are the `Compos.Core.Browser`
  ...
  def init(state) do
    Browser.attach(self())
    hello = Jason.encode!(%{event: "hello", name: Application.get_env(:compos_core, :name, "compos")})
