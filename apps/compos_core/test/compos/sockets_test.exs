defmodule Compos.SocketsTest do
  ...
  describe "the listener inventory" do
    ...
    # solo-app runs boot neither compos_rpc nor compos_ui; the partitioned
    ...
    test "restart_listener on rpc bounces it, or reports it absent" do
      case Process.whereis(Compos.Rpc.Supervisor) do
  ...
  describe "the sockets buffer" do
    setup do
      ...
      on_exit(fn -> Compos.Core.kill_buffer("*sockets*") end)
      :ok
    end
