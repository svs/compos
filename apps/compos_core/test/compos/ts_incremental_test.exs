defmodule Compos.TsIncrementalTest do
  use ExUnit.Case

  alias Compos.Core.{Buffer, TS}
  ...
  defp new_buffer do
    ...
    {:ok, _} = Compos.Core.create_buffer(name, text: @initial)
  ...
  test "buffers without ts-lang highlight to []" do
    ...
    {:ok, _} = Compos.Core.create_buffer(name, text: "plain text")
