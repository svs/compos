defmodule Compos.UvariableSchemeTest do
  @moduledoc """
  Runs priv/tests/variable-test.scm alone: variable.
  """
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "variable-test.scm"])
  ...
  @tag timeout: 120_000
  test "variable-test.scm passes" do
    eval!(~s{(load "#{@file_}")})
    names = names()
