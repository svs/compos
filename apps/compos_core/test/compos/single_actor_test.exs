defmodule Compos.SingleActorTest do
  use ExUnit.Case

  alias Compos.Core.{Lane, Session}

  setup do
    previous = Application.get_env(:compos_core, :scheme_execution, :lanes)
    Application.put_env(:compos_core, :scheme_execution, :single_actor)

    on_exit(fn ->
      Lane.kill(:scheme)
      Application.put_env(:compos_core, :scheme_execution, previous)
    end)
