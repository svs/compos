...
(define-theme "paper"                ; the design default (light) — restorable
  (list
    ...
    (list 'llm-rewrite 'fg "#7a5a1a" 'style "italic")
    (list 'llm-rewrite-source 'fg "#8a857a" 'style "italic")
    (list 'dim 'fg "#8a857a")
...
(define-theme "paper-night"          ; the design's warm dark
  (list
    ...
    (list 'llm-rewrite 'fg "#d5ac66" 'style "italic")
    (list 'llm-rewrite-source 'fg "#a79d8c" 'style "italic")
    (list 'dim 'fg "#a79d8c")
...
(define-theme "compos-dark"
  (list
    ...
    (list 'llm-rewrite 'fg "#e0af68" 'style "italic")
    (list 'llm-rewrite-source 'fg "#8b8fa3" 'style "italic")
    (list 'dim 'fg "#8b8fa3")
...
(define-theme "catppuccin-mocha"
  (list
    ...
    (list 'llm-rewrite 'fg "#fab387" 'style "italic")
    (list 'llm-rewrite-source 'fg "#6c7086" 'style "italic")
    (list 'dim 'fg "#6c7086")
