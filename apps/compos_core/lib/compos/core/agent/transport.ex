defmodule Compos.Core.Agent.Transport do
  @moduledoc """
  ...
  def impl, do: Application.get_env(:compos_core, :acp_transport, __MODULE__.Port)
end

defmodule Compos.Core.Agent.Transport.Port do
  @moduledoc """
